...
export const roadmapSteps: Array<RoadmapStep<RoadmapStepExtras>> = [
    {
        ...
        links: [
            {
                label: "Математическая логика и теория алгоритмов",
                url: "https://pusk.mipt.ru/course/view.php?id=500",
            },
        ],
        checklist: [
            "знать фундаментальные результаты теории вычислимых функций: существование функций, невычислимых на компьютере, примеры алгоритмически неразрешимых задач",
            "знать существование программы, печатающей свой текст, существование истинных, но недоказуемых утверждений, существование программы, про которую ничего нельзя доказать",
